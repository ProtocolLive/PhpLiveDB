...
require_once(__DIR__ . '/Enums/Operators.php');
require_once(__DIR__ . '/Enums/Parenthesis.php');
require_once(__DIR__ . '/Enums/RefTypes.php');
require_once(__DIR__ . '/Enums/Types.php');
require_once(__DIR__ . '/Basics.php');
require_once(__DIR__ . '/Create.php');
require_once(__DIR__ . '/Delete.php');
require_once(__DIR__ . '/Field.php');
require_once(__DIR__ . '/Insert.php');
require_once(__DIR__ . '/InsertUpdate.php');
require_once(__DIR__ . '/PhpLiveDb.php');
